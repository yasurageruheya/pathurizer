class PathParser
{
	...
	constructor(url)
	{
		...
		if(url.charAt(url.length-1) === "/") this.trailing = "/";
	...
	get toDirectories()
	{
		return (this.protocol ? this.protocol + "://" : "") +
			...
			(this.directories.length ? (this.host ? "/" : "") + this.directories.join("/") : "") +
			this.trailing;
	}
	...
	get toFileName()
	{
		return (this.protocol ? this.protocol + "://" : "") +
			this.host + (this.port ? ":" + this.port : "") + this.root +
			(this.directories.length ? (this.host ? "/" : "") + this.directories.join("/") : "") +
			(this.fileName ? (this.directories.length || this.host ? "/" : "") + this.fileName : "") +
			this.trailing;
	}
	...
	get toFileNameIgnoreExtension()
	{
		return (this.protocol ? this.protocol + "://" : "") +
			this.host + (this.port ? ":" + this.port : "") + this.root +
			(this.directories.length ? (this.host ? "/" : "") + this.directories.join("/") : "") +
			(this.ignoreExtension ? (this.directories.length || this.host ? "/" : "") + this.ignoreExtension : "") +
			this.trailing;
	}
	...
	clone()
	{
		return new PathParser(this.url);
	}
}
